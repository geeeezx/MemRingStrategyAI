        ...
        <div className="grid grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
          ...
          >
            <div className="card-content relative w-full aspect-[2/3] transform transition-transform duration-500 group-hover:rotate-y-180 preserve-3d">
              <div className="absolute w-full h-full bg-gradient-to-b from-white to-gray-50 dark:from-[#1a1a1a] dark:to-[#0d0d0d] border border-gray-200 dark:border-white/10 rounded-lg flex items-center justify-center backface-hidden shadow-lg">
                <svg className="w-12 h-12 text-gray-400 dark:text-white/40" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M12 4L8 8M12 4L16 8M12 4V20M4 12H20" strokeWidth="1" />
                </svg>
              </div>
              <div className="absolute w-full h-full bg-gray-50 dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-lg p-4 rotate-y-180 backface-hidden shadow-lg">
                <div className="text-gray-600 dark:text-white/70 text-sm font-light">Deck of Thoth</div>
                <div className="mt-4 text-gray-500 dark:text-white/50 text-xs font-light italic">
                  {deckQuestions.thoth}
                </div>
              </div>
            </div>
          ...
          >
            <div className="card-content relative w-full aspect-[2/3] transform transition-transform duration-500 group-hover:rotate-y-180 preserve-3d">
              <div className="absolute w-full h-full bg-gradient-to-b from-white to-gray-50 dark:from-[#1a1a1a] dark:to-[#0d0d0d] border border-gray-200 dark:border-white/10 rounded-lg flex items-center justify-center backface-hidden shadow-lg">
                <svg className="w-12 h-12 text-gray-400 dark:text-white/40" viewBox="0 0 1388 1388" fill="none" stroke="currentColor">
              ...
              <div className="absolute w-full h-full bg-gray-50 dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-lg p-4 rotate-y-180 backface-hidden shadow-lg">
                <div className="text-gray-600 dark:text-white/70 text-sm font-light">Deck of Anubis</div>
                <div className="mt-4 text-gray-500 dark:text-white/50 text-xs font-light italic">
          ...
          >
            <div className="card-content relative w-full aspect-[2/3] transform transition-transform duration-500 group-hover:rotate-y-180 preserve-3d">
              ...
              <div className="absolute w-full h-full bg-gray-50 dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-lg p-4 rotate-y-180 backface-hidden shadow-lg">
                <div className="text-gray-600 dark:text-white/70 text-sm font-light">Deck of Isis</div>
                <div className="mt-4 text-gray-500 dark:text-white/50 text-xs font-light italic">
                  {deckQuestions.isis}
                </div>
              </div>
